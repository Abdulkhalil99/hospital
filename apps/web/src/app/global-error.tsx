      ...
      >
        ...
        >
          ...
          <h1 style={{ fontSize: 30, lineHeight: 1.15, margin: '0 0 12px', color: '#0f172a' }}>
            MediCore could not recover from this render.
          </h1>
          <p style={{ fontSize: 14, lineHeight: 1.7, color: '#475569', margin: '0 0 18px' }}>
            This is the global error boundary for the Next.js app router. It prevents broken
            refresh loops during development and gives the app a stable fallback UI.
          </p>
